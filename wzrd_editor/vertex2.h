//
// Declaration of the vertex2 class.
//
...
{
	struct vertex2 : vertex2T<vertex2>
	{
		vertex2() = default;

		vertex2(float x, float y, float z, float r, float g, float b, float a, float u, float v);
...
{
	struct vertex2 : vertex2T<vertex2, implementation::vertex2>
	{
	};
}
